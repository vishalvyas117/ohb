...
public class Constant {
    ...
    public static enum BOOKING_STATUS {
        PENDING(0),
        INPROGRESS(1),
        BOOKED(2);
        ...
        private BOOKING_STATUS(int status) {
            this.status = status;
        }
    ...
    public static enum HOTEL_ATTRIBUTE {
        DETAIL_IMAGES(1, "Detail images");
        
        private final int id;
        private final String name;
        
        private HOTEL_ATTRIBUTE(int id, String name) {
            this.id = id;
            this.name = name;
        }
    ...
    public static final int SORT_BY_HOTEL_PRICE = 2;
}
